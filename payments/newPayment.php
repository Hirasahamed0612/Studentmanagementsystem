          ...
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="form-group">
                ...
                <input type="text" name="paymentName" class="form-control" placeholder="Payment Name">
              </div>
            </div>
            <div class="col-md-12"> 
              <div class="form-group">
...
var table;
var images=[];
$("#payments a:eq(0),#payments a:eq(1)").addClass("active");
...
data.append("description",CKEDITOR.instances['description'].getData())
        $.ajax({
          url: '<?php echo $base_url;?>/payments/vendor/newPayment',
          type: 'POST',
          data: data,
