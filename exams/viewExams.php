  ...
  <div class="modal-dialog modal-dialog-centered ">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <span class="text-danger">All students marks related to this exam will be deleted</span>
      </div>
...
var table;
$("#exams a:eq(0),#exams a:eq(2)").addClass("active");
$("#exams").removeClass("menu-close").addClass("menu-open");
//funtion for inz table
function inz(){
 table=$('#dtTable').DataTable({
  "ajax": {
    "url": "<?php echo $base_url;?>/exams/vendor/retriveExams",
    "type": "POST"
  },
...
function delete_record(id){
  $.ajax({
    url: '<?php echo $base_url;?>/exams/vendor/deleteExam',
    type: 'POST',
    data: {
      id:id
    },
    success: function(result) {
      if(result==1){
        ...
        alertify.dismissAll();
        alertify.success('<i class="fa fa-check"></i> Exam Deleted');
      }
      else{
        alert(result);
      }
